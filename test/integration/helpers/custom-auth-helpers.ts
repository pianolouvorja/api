...
import { generateSessionToken, hashPassword, hashToken } from "../../../src/v1/custom/auth.service.js";
...
export function registerUser(email: string, password: string): {
  ...
  db.prepare("INSERT INTO custom_sessions (token_hash, id_user) VALUES (?, ?)").run(
    hashToken(token),
    id,
  );
